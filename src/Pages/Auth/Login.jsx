...
function Login({ setIsLogin }) {
  ...
  return (
    <>
      <div className=" transition-all z-10 h-full flex flex-col items-center">
        ...
        <form className="mx-6 my-2.5 w-90" onSubmit={navigateHome}>
          <div>
            <div className="flex flex-col  w-full">
              ...
              <input
                ...
                className="hover:border-gray-700 focus:border-gray-700 required:border-red transition duration-1000 border text-base border-gray-600 ease-in-out text-gray-500 rounded bg-transparent p-2.5"
              />
            </div>
          ...
          <div className="w-full ">
            ...
            >
              <p className="text-gray-500 text-xs">Not registered yet? </p>

              <p className="text-gray-700 text-xs mx-1 ">Register </p>
